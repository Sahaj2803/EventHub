...
const CreateEvent: React.FC = () => {
  ...
  const {
    ...
    // Casting to any to align yupResolver with EventFormData at runtime
    resolver: yupResolver(schema) as unknown as Resolver<EventFormData>,
    defaultValues: {
      pricing: {
        isFree: false,
        currency: 'USD',
        tiers: [{ name: 'General Admission', price: 0, description: '', quantity: 100 }],
      },
      visibility: 'public',
      tags: [],
    },
  ...
  const { fields: tierFields, append: appendTier, remove: removeTier } = useFieldArray<EventFormData>({
    control,
    // Cast name to const to satisfy literal type
                ...
                <Paper elevation={2} sx={{ p: 3 }}>
                  ...
                  >
                    {createEventMutation.isPending ? (
                      ...
                      isDraft ? 'Save as Draft' : 'Publish Event'
                    )}
                  </Button>
